...
static const struct pad_config gpio_table[] = {
	...
	/* VGPIO_1 - GPIO */
	_PAD_CFG_STRUCT(VGPIO_1, PAD_FUNC(GPIO) | PAD_RESET(PWROK) | PAD_BUF(TX_DISABLE) | PAD_CFG0_NAFVWE_ENABLE, 0),
	/* VGPIO_10 - GPIO */
	_PAD_CFG_STRUCT(VGPIO_10, PAD_FUNC(GPIO) | PAD_RESET(PLTRST) | PAD_BUF(TX_DISABLE) | PAD_CFG0_NAFVWE_ENABLE, 0),
	/* VGPIO_11 - GPIO */
	...
	/* VGPIO_14 - GPIO */
	_PAD_CFG_STRUCT(VGPIO_14, PAD_FUNC(GPIO) | PAD_RESET(DEEP) | PAD_BUF(TX_DISABLE), 0),
	/* VGPIO_15 - GPIO */
	_PAD_CFG_STRUCT(VGPIO_15, PAD_FUNC(GPIO) | PAD_RESET(RSMRST) | PAD_BUF(RX_DISABLE) | 1 | PAD_CFG0_NAFVWE_ENABLE, 0),
	/* VGPIO_16 - GPIO */
	...
	/* VGPIO_19 - NF6 */
	_PAD_CFG_STRUCT(VGPIO_19, PAD_FUNC(NF6) | PAD_RESET(PWROK), 0),
	/* VGPIO_2 - GPIO */
	_PAD_CFG_STRUCT(VGPIO_2, PAD_FUNC(GPIO) | PAD_RESET(PWROK) | PAD_BUF(TX_DISABLE) | PAD_CFG0_NAFVWE_ENABLE, 0),
	/* VGPIO_20 - GPIO */
	_PAD_CFG_STRUCT(VGPIO_20, PAD_FUNC(GPIO) | PAD_RESET(DEEP) | PAD_BUF(TX_DISABLE), 0),
	/* VGPIO_21 - NF5 */
	_PAD_CFG_STRUCT(VGPIO_21, PAD_FUNC(NF5) | PAD_RESET(RSMRST), 0),
	/* VGPIO_22 - GPIO */
	_PAD_CFG_STRUCT(VGPIO_22, PAD_FUNC(GPIO) | PAD_RESET(DEEP) | PAD_BUF(TX_DISABLE) | PAD_CFG0_NAFVWE_ENABLE, 0),
	/* VGPIO_23 - NF4 */
	_PAD_CFG_STRUCT(VGPIO_23, PAD_FUNC(NF4) | PAD_RESET(RSMRST), 0),
	/* VGPIO_24 - GPIO */
	_PAD_CFG_STRUCT(VGPIO_24, PAD_FUNC(GPIO) | PAD_RESET(RSMRST) | PAD_BUF(RX_DISABLE), 0),
	/* VGPIO_25 - GPIO */
	...
	/* VGPIO_27 - NF4 */
	_PAD_CFG_STRUCT(VGPIO_27, PAD_FUNC(NF4) | PAD_RESET(DEEP), 0),
	/* VGPIO_28 - NF7 */
	_PAD_CFG_STRUCT(VGPIO_28, PAD_FUNC(NF7) | PAD_RESET(PWROK) | PAD_CFG0_NAFVWE_ENABLE, 0),
	/* VGPIO_29 - GPIO */
	_PAD_CFG_STRUCT(VGPIO_29, PAD_FUNC(GPIO) | PAD_RESET(RSMRST) | PAD_BUF(RX_DISABLE) | 1 | PAD_CFG0_NAFVWE_ENABLE, 0),
	/* VGPIO_3 - GPIO */
	_PAD_CFG_STRUCT(VGPIO_3, PAD_FUNC(GPIO) | PAD_RESET(PLTRST) | PAD_BUF(TX_DISABLE), 0),
	/* VGPIO_30 - NF2 */
	_PAD_CFG_STRUCT(VGPIO_30, PAD_FUNC(NF2) | PAD_RESET(RSMRST) | PAD_CFG0_NAFVWE_ENABLE, 0),
	/* VGPIO_31 - NF6 */
	_PAD_CFG_STRUCT(VGPIO_31, PAD_FUNC(NF6) | PAD_RESET(PLTRST), 0),
	/* VGPIO_32 - NF7 */
	_PAD_CFG_STRUCT(VGPIO_32, PAD_FUNC(NF7) | PAD_RESET(PLTRST), 0),
	/* VGPIO_33 - NF7 */
	_PAD_CFG_STRUCT(VGPIO_33, PAD_FUNC(NF7) | PAD_RESET(PWROK) | PAD_CFG0_NAFVWE_ENABLE, 0),
	/* VGPIO_34 - GPIO */
	_PAD_CFG_STRUCT(VGPIO_34, PAD_FUNC(GPIO) | PAD_RESET(RSMRST) | PAD_BUF(TX_DISABLE), 0),
	/* VGPIO_35 - NF4 */
	_PAD_CFG_STRUCT(VGPIO_35, PAD_FUNC(NF4) | PAD_RESET(PWROK), 0),
	/* VGPIO_36 - NF6 */
	_PAD_CFG_STRUCT(VGPIO_36, PAD_FUNC(NF6) | PAD_RESET(PLTRST), 0),
	/* VGPIO_37 - GPIO */
	...
	/* VGPIO_4 - NF7 */
	_PAD_CFG_STRUCT(VGPIO_4, PAD_FUNC(NF7) | PAD_RESET(PLTRST) | PAD_CFG0_NAFVWE_ENABLE, 0),
	/* VGPIO_5 - NF4 */
	_PAD_CFG_STRUCT(VGPIO_5, PAD_FUNC(NF4) | PAD_RESET(DEEP) | PAD_CFG0_NAFVWE_ENABLE, 0),
	/* VGPIO_6 - NF5 */
	_PAD_CFG_STRUCT(VGPIO_6, PAD_FUNC(NF5) | PAD_RESET(RSMRST) | PAD_CFG0_NAFVWE_ENABLE, 0),
	/* VGPIO_7 - GPIO */
	_PAD_CFG_STRUCT(VGPIO_7, PAD_FUNC(GPIO) | PAD_RESET(RSMRST) | PAD_BUF(TX_DISABLE), 0),
	/* VGPIO_8 - NF3 */
	_PAD_CFG_STRUCT(VGPIO_8, PAD_FUNC(NF3) | PAD_RESET(RSMRST), 0),
	/* VGPIO_9 - NF7 */
	_PAD_CFG_STRUCT(VGPIO_9, PAD_FUNC(NF7) | PAD_RESET(PWROK) | PAD_CFG0_NAFVWE_ENABLE, 0),
