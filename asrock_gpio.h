...
static const struct pad_config gpio_table[] = {
	...
	/* VGPIO_10 - NF2 */
	_PAD_CFG_STRUCT(VGPIO_10, PAD_FUNC(NF2) | PAD_RESET(PLTRST), 0),
	/* VGPIO_11 - GPIO */
	_PAD_CFG_STRUCT(VGPIO_11, PAD_FUNC(GPIO) | PAD_RESET(PLTRST) | PAD_BUF(TX_DISABLE) | PAD_CFG0_NAFVWE_ENABLE, 0),
	/* VGPIO_12 - GPIO */
	_PAD_CFG_STRUCT(VGPIO_12, PAD_FUNC(GPIO) | PAD_RESET(PWROK) | PAD_BUF(TX_DISABLE) | PAD_CFG0_NAFVWE_ENABLE, 0),
	/* VGPIO_13 - GPIO */
	_PAD_CFG_STRUCT(VGPIO_13, PAD_FUNC(GPIO) | PAD_RESET(PLTRST) | PAD_BUF(TX_DISABLE) | PAD_CFG0_NAFVWE_ENABLE, 0),
	/* VGPIO_14 - GPIO */
	...
	/* VGPIO_16 - GPIO */
	_PAD_CFG_STRUCT(VGPIO_16, PAD_FUNC(GPIO) | PAD_RESET(PWROK) | PAD_BUF(TX_DISABLE) | PAD_CFG0_NAFVWE_ENABLE, 0),
	/* VGPIO_17 - GPIO */
	_PAD_CFG_STRUCT(VGPIO_17, PAD_FUNC(GPIO) | PAD_RESET(RSMRST) | PAD_BUF(TX_DISABLE), 0),
	/* VGPIO_18 - GPIO */
	...
	/* VGPIO_2 - NF6 */
	_PAD_CFG_STRUCT(VGPIO_2, PAD_FUNC(NF6) | PAD_RESET(RSMRST) | PAD_CFG0_NAFVWE_ENABLE, 0),
	/* VGPIO_20 - GPIO */
	_PAD_CFG_STRUCT(VGPIO_20, PAD_FUNC(GPIO) | PAD_RESET(RSMRST) | PAD_BUF(TX_DISABLE) | PAD_CFG0_NAFVWE_ENABLE, 0),
	/* VGPIO_21 - GPIO */
	_PAD_CFG_STRUCT(VGPIO_21, PAD_FUNC(GPIO) | PAD_RESET(DEEP) | PAD_BUF(TX_DISABLE) | PAD_CFG0_NAFVWE_ENABLE, 0),
	/* VGPIO_22 - NF4 */
	_PAD_CFG_STRUCT(VGPIO_22, PAD_FUNC(NF4) | PAD_RESET(PWROK), 0),
	/* VGPIO_23 - GPIO */
	...
	/* VGPIO_25 - NF3 */
	_PAD_CFG_STRUCT(VGPIO_25, PAD_FUNC(NF3) | PAD_RESET(PLTRST), 0),
	/* VGPIO_26 - NF7 */
	_PAD_CFG_STRUCT(VGPIO_26, PAD_FUNC(NF7) | PAD_RESET(PLTRST) | PAD_CFG0_NAFVWE_ENABLE, 0),
	/* VGPIO_27 - GPIO */
	_PAD_CFG_STRUCT(VGPIO_27, PAD_FUNC(GPIO) | PAD_RESET(PWROK) | PAD_BUF(RX_DISABLE) | PAD_CFG0_NAFVWE_ENABLE, 0),
	/* VGPIO_28 - GPIO */
	_PAD_CFG_STRUCT(VGPIO_28, PAD_FUNC(GPIO) | PAD_RESET(RSMRST) | PAD_BUF(TX_DISABLE), 0),
	/* VGPIO_29 - NF7 */
	_PAD_CFG_STRUCT(VGPIO_29, PAD_FUNC(NF7) | PAD_RESET(RSMRST) | PAD_CFG0_NAFVWE_ENABLE, 0),
	/* VGPIO_3 - NF2 */
	_PAD_CFG_STRUCT(VGPIO_3, PAD_FUNC(NF2) | PAD_RESET(RSMRST), 0),
	/* VGPIO_30 - NF5 */
	_PAD_CFG_STRUCT(VGPIO_30, PAD_FUNC(NF5) | PAD_RESET(PWROK) | PAD_CFG0_NAFVWE_ENABLE, 0),
	/* VGPIO_31 - NF4 */
	_PAD_CFG_STRUCT(VGPIO_31, PAD_FUNC(NF4) | PAD_RESET(PLTRST), 0),
	/* VGPIO_32 - GPIO */
	_PAD_CFG_STRUCT(VGPIO_32, PAD_FUNC(GPIO) | PAD_RESET(DEEP) | PAD_BUF(TX_DISABLE) | PAD_CFG0_NAFVWE_ENABLE, 0),
	/* VGPIO_33 - NF2 */
	_PAD_CFG_STRUCT(VGPIO_33, PAD_FUNC(NF2) | PAD_RESET(DEEP), 0),
	/* VGPIO_34 - GPIO */
	...
	/* VGPIO_4 - NF4 */
	_PAD_CFG_STRUCT(VGPIO_4, PAD_FUNC(NF4) | PAD_RESET(PLTRST), 0),
	/* VGPIO_5 - GPIO */
	_PAD_CFG_STRUCT(VGPIO_5, PAD_FUNC(GPIO) | PAD_RESET(PLTRST) | PAD_BUF(TX_DISABLE), 0),
	/* VGPIO_6 - GPIO */
	_PAD_CFG_STRUCT(VGPIO_6, PAD_FUNC(GPIO) | PAD_RESET(PWROK) | PAD_BUF(RX_DISABLE) | 1 | PAD_CFG0_NAFVWE_ENABLE, 0),
	/* VGPIO_7 - NF6 */
	_PAD_CFG_STRUCT(VGPIO_7, PAD_FUNC(NF6) | PAD_RESET(PWROK) | PAD_CFG0_NAFVWE_ENABLE, 0),
	/* VGPIO_8 - GPIO */
	_PAD_CFG_STRUCT(VGPIO_8, PAD_FUNC(GPIO) | PAD_RESET(RSMRST) | PAD_BUF(RX_DISABLE) | PAD_CFG0_NAFVWE_ENABLE, 0),
	/* VGPIO_9 - GPIO */
	_PAD_CFG_STRUCT(VGPIO_9, PAD_FUNC(GPIO) | PAD_RESET(PWROK) | PAD_BUF(TX_DISABLE), 0),

	/* ------- GPIO Group VGPIO_0 ------- */

	/* VGPIO_USB_0 - GPIO */
	_PAD_CFG_STRUCT(VGPIO_USB_0, PAD_FUNC(GPIO) | PAD_RESET(DEEP) | PAD_BUF(RX_DISABLE), 0),
	/* VGPIO_USB_1 - NF2 */
	_PAD_CFG_STRUCT(VGPIO_USB_1, PAD_FUNC(NF2) | PAD_RESET(PWROK) | PAD_CFG0_NAFVWE_ENABLE, 0),
	/* VGPIO_USB_10 - GPIO */
	_PAD_CFG_STRUCT(VGPIO_USB_10, PAD_FUNC(GPIO) | PAD_RESET(DEEP) | PAD_BUF(RX_DISABLE) | PAD_CFG0_NAFVWE_ENABLE, 0),
	/* VGPIO_USB_11 - GPIO */
	_PAD_CFG_STRUCT(VGPIO_USB_11, PAD_FUNC(GPIO) | PAD_RESET(PLTRST) | PAD_BUF(TX_DISABLE) | PAD_CFG0_NAFVWE_ENABLE, 0),
	/* VGPIO_USB_12 - GPIO */
	_PAD_CFG_STRUCT(VGPIO_USB_12, PAD_FUNC(GPIO) | PAD_RESET(DEEP) | PAD_BUF(RX_DISABLE) | 1, 0),
	/* VGPIO_USB_13 - NF2 */
	...
	/* VGPIO_USB_3 - GPIO */
	_PAD_CFG_STRUCT(VGPIO_USB_3, PAD_FUNC(GPIO) | PAD_RESET(PWROK) | PAD_BUF(RX_DISABLE) | 1 | PAD_CFG0_NAFVWE_ENABLE, 0),
	/* VGPIO_USB_4 - GPIO */
	_PAD_CFG_STRUCT(VGPIO_USB_4, PAD_FUNC(GPIO) | PAD_RESET(DEEP) | PAD_BUF(RX_DISABLE) | PAD_CFG0_NAFVWE_ENABLE, 0),
	/* VGPIO_USB_5 - GPIO */
	_PAD_CFG_STRUCT(VGPIO_USB_5, PAD_FUNC(GPIO) | PAD_RESET(DEEP) | PAD_BUF(TX_DISABLE) | PAD_CFG0_NAFVWE_ENABLE, 0),
	/* VGPIO_USB_6 - GPIO */
	...
	/* VGPIO_USB_8 - NF6 */
	_PAD_CFG_STRUCT(VGPIO_USB_8, PAD_FUNC(NF6) | PAD_RESET(PLTRST), 0),
	/* VGPIO_USB_9 - GPIO */
	_PAD_CFG_STRUCT(VGPIO_USB_9, PAD_FUNC(GPIO) | PAD_RESET(DEEP) | PAD_BUF(TX_DISABLE) | PAD_CFG0_NAFVWE_ENABLE, 0),
	...
	/* VGPIO_PCIE_1 - GPIO */
	_PAD_CFG_STRUCT(VGPIO_PCIE_1, PAD_FUNC(GPIO) | PAD_RESET(RSMRST) | PAD_BUF(RX_DISABLE), 0),
	/* VGPIO_PCIE_10 - GPIO */
	_PAD_CFG_STRUCT(VGPIO_PCIE_10, PAD_FUNC(GPIO) | PAD_RESET(PWROK) | PAD_BUF(TX_DISABLE), 0),
	/* VGPIO_PCIE_11 - GPIO */
	_PAD_CFG_STRUCT(VGPIO_PCIE_11, PAD_FUNC(GPIO) | PAD_RESET(RSMRST) | PAD_BUF(TX_DISABLE), 0),
	/* VGPIO_PCIE_12 - GPIO */
	_PAD_CFG_STRUCT(VGPIO_PCIE_12, PAD_FUNC(GPIO) | PAD_RESET(RSMRST) | PAD_BUF(TX_DISABLE) | PAD_CFG0_NAFVWE_ENABLE, 0),
	/* VGPIO_PCIE_13 - NF2 */
	_PAD_CFG_STRUCT(VGPIO_PCIE_13, PAD_FUNC(NF2) | PAD_RESET(PLTRST), 0),
	/* VGPIO_PCIE_14 - GPIO */
	...
	/* VGPIO_PCIE_16 - GPIO */
	_PAD_CFG_STRUCT(VGPIO_PCIE_16, PAD_FUNC(GPIO) | PAD_RESET(PLTRST) | PAD_BUF(TX_DISABLE) | PAD_CFG0_NAFVWE_ENABLE, 0),
	/* VGPIO_PCIE_17 - GPIO */
	_PAD_CFG_STRUCT(VGPIO_PCIE_17, PAD_FUNC(GPIO) | PAD_RESET(RSMRST) | PAD_BUF(TX_DISABLE) | PAD_CFG0_NAFVWE_ENABLE, 0),
	/* VGPIO_PCIE_18 - NF5 */
	_PAD_CFG_STRUCT(VGPIO_PCIE_18, PAD_FUNC(NF5) | PAD_RESET(RSMRST), 0),
	/* VGPIO_PCIE_19 - NF5 */
	_PAD_CFG_STRUCT(VGPIO_PCIE_19, PAD_FUNC(NF5) | PAD_RESET(RSMRST) | PAD_CFG0_NAFVWE_ENABLE, 0),
	/* VGPIO_PCIE_2 - GPIO */
	_PAD_CFG_STRUCT(VGPIO_PCIE_2, PAD_FUNC(GPIO) | PAD_RESET(RSMRST) | PAD_BUF(RX_DISABLE) | 1 | PAD_CFG0_NAFVWE_ENABLE, 0),
	/* VGPIO_PCIE_20 - NF7 */
	_PAD_CFG_STRUCT(VGPIO_PCIE_20, PAD_FUNC(NF7) | PAD_RESET(PWROK) | PAD_CFG0_NAFVWE_ENABLE, 0),
	/* VGPIO_PCIE_21 - GPIO */
	_PAD_CFG_STRUCT(VGPIO_PCIE_21, PAD_FUNC(GPIO) | PAD_RESET(RSMRST) | PAD_BUF(TX_DISABLE) | PAD_CFG0_NAFVWE_ENABLE, 0),
	/* VGPIO_PCIE_22 - NF3 */
	_PAD_CFG_STRUCT(VGPIO_PCIE_22, PAD_FUNC(NF3) | PAD_RESET(DEEP), 0),
	/* VGPIO_PCIE_23 - GPIO */
	_PAD_CFG_STRUCT(VGPIO_PCIE_23, PAD_FUNC(GPIO) | PAD_RESET(RSMRST) | PAD_BUF(TX_DISABLE) | PAD_CFG0_NAFVWE_ENABLE, 0),
	/* VGPIO_PCIE_24 - GPIO */
	_PAD_CFG_STRUCT(VGPIO_PCIE_24, PAD_FUNC(GPIO) | PAD_RESET(PLTRST) | PAD_BUF(TX_DISABLE), 0),
	/* VGPIO_PCIE_25 - GPIO */
	_PAD_CFG_STRUCT(VGPIO_PCIE_25, PAD_FUNC(GPIO) | PAD_RESET(PLTRST) | PAD_BUF(RX_DISABLE) | 1 | PAD_CFG0_NAFVWE_ENABLE, 0),
	/* VGPIO_PCIE_26 - NF4 */
	_PAD_CFG_STRUCT(VGPIO_PCIE_26, PAD_FUNC(NF4) | PAD_RESET(PLTRST), 0),
	/* VGPIO_PCIE_27 - NF2 */
	_PAD_CFG_STRUCT(VGPIO_PCIE_27, PAD_FUNC(NF2) | PAD_RESET(DEEP), 0),
	/* VGPIO_PCIE_28 - NF7 */
	_PAD_CFG_STRUCT(VGPIO_PCIE_28, PAD_FUNC(NF7) | PAD_RESET(RSMRST), 0),
	/* VGPIO_PCIE_29 - GPIO */
	_PAD_CFG_STRUCT(VGPIO_PCIE_29, PAD_FUNC(GPIO) | PAD_RESET(PLTRST) | PAD_BUF(TX_DISABLE), 0),
	/* VGPIO_PCIE_3 - NF2 */
	_PAD_CFG_STRUCT(VGPIO_PCIE_3, PAD_FUNC(NF2) | PAD_RESET(RSMRST), 0),
	/* VGPIO_PCIE_30 - NF6 */
	_PAD_CFG_STRUCT(VGPIO_PCIE_30, PAD_FUNC(NF6) | PAD_RESET(DEEP), 0),
	/* VGPIO_PCIE_31 - GPIO */
	_PAD_CFG_STRUCT(VGPIO_PCIE_31, PAD_FUNC(GPIO) | PAD_RESET(RSMRST) | PAD_BUF(TX_DISABLE) | PAD_CFG0_NAFVWE_ENABLE, 0),
	/* VGPIO_PCIE_32 - GPIO */
	_PAD_CFG_STRUCT(VGPIO_PCIE_32, PAD_FUNC(GPIO) | PAD_RESET(PLTRST) | PAD_BUF(RX_DISABLE) | 1 | PAD_CFG0_NAFVWE_ENABLE, 0),
	/* VGPIO_PCIE_33 - GPIO */
	_PAD_CFG_STRUCT(VGPIO_PCIE_33, PAD_FUNC(GPIO) | PAD_RESET(PLTRST) | PAD_BUF(RX_DISABLE) | 1, 0),
	/* VGPIO_PCIE_34 - NF2 */
	_PAD_CFG_STRUCT(VGPIO_PCIE_34, PAD_FUNC(NF2) | PAD_RESET(DEEP) | PAD_CFG0_NAFVWE_ENABLE, 0),
	/* VGPIO_PCIE_35 - GPIO */
	_PAD_CFG_STRUCT(VGPIO_PCIE_35, PAD_FUNC(GPIO) | PAD_RESET(DEEP) | PAD_BUF(TX_DISABLE) | PAD_CFG0_NAFVWE_ENABLE, 0),
	/* VGPIO_PCIE_36 - GPIO */
	_PAD_CFG_STRUCT(VGPIO_PCIE_36, PAD_FUNC(GPIO) | PAD_RESET(PLTRST) | PAD_BUF(RX_DISABLE), 0),
	/* VGPIO_PCIE_37 - GPIO */
	_PAD_CFG_STRUCT(VGPIO_PCIE_37, PAD_FUNC(GPIO) | PAD_RESET(RSMRST) | PAD_BUF(TX_DISABLE) | PAD_CFG0_NAFVWE_ENABLE, 0),
	/* VGPIO_PCIE_38 - GPIO */
	_PAD_CFG_STRUCT(VGPIO_PCIE_38, PAD_FUNC(GPIO) | PAD_RESET(DEEP) | PAD_BUF(TX_DISABLE) | PAD_CFG0_NAFVWE_ENABLE, 0),
	/* VGPIO_PCIE_39 - GPIO */
	_PAD_CFG_STRUCT(VGPIO_PCIE_39, PAD_FUNC(GPIO) | PAD_RESET(PLTRST) | PAD_BUF(TX_DISABLE), 0),
	/* VGPIO_PCIE_4 - GPIO */
	_PAD_CFG_STRUCT(VGPIO_PCIE_4, PAD_FUNC(GPIO) | PAD_RESET(PWROK) | PAD_BUF(RX_DISABLE) | 1 | PAD_CFG0_NAFVWE_ENABLE, 0),
	/* VGPIO_PCIE_40 - GPIO */
	_PAD_CFG_STRUCT(VGPIO_PCIE_40, PAD_FUNC(GPIO) | PAD_RESET(PLTRST) | PAD_BUF(RX_DISABLE) | 1 | PAD_CFG0_NAFVWE_ENABLE, 0),
	/* VGPIO_PCIE_41 - GPIO */
	_PAD_CFG_STRUCT(VGPIO_PCIE_41, PAD_FUNC(GPIO) | PAD_RESET(RSMRST) | PAD_BUF(TX_DISABLE) | PAD_CFG0_NAFVWE_ENABLE, 0),
	/* VGPIO_PCIE_42 - GPIO */
	_PAD_CFG_STRUCT(VGPIO_PCIE_42, PAD_FUNC(GPIO) | PAD_RESET(PWROK) | PAD_BUF(RX_DISABLE) | PAD_CFG0_NAFVWE_ENABLE, 0),
	/* VGPIO_PCIE_43 - GPIO */
	_PAD_CFG_STRUCT(VGPIO_PCIE_43, PAD_FUNC(GPIO) | PAD_RESET(RSMRST) | PAD_BUF(RX_DISABLE) | 1, 0),
	/* VGPIO_PCIE_44 - GPIO */
	_PAD_CFG_STRUCT(VGPIO_PCIE_44, PAD_FUNC(GPIO) | PAD_RESET(DEEP) | PAD_BUF(TX_DISABLE) | PAD_CFG0_NAFVWE_ENABLE, 0),
	/* VGPIO_PCIE_45 - GPIO */
	_PAD_CFG_STRUCT(VGPIO_PCIE_45, PAD_FUNC(GPIO) | PAD_RESET(PLTRST) | PAD_BUF(RX_DISABLE) | 1, 0),
	/* VGPIO_PCIE_46 - GPIO */
	_PAD_CFG_STRUCT(VGPIO_PCIE_46, PAD_FUNC(GPIO) | PAD_RESET(PLTRST) | PAD_BUF(TX_DISABLE) | PAD_CFG0_NAFVWE_ENABLE, 0),
	/* VGPIO_PCIE_47 - GPIO */
	_PAD_CFG_STRUCT(VGPIO_PCIE_47, PAD_FUNC(GPIO) | PAD_RESET(PWROK) | PAD_BUF(TX_DISABLE) | PAD_CFG0_NAFVWE_ENABLE, 0),
	/* VGPIO_PCIE_48 - GPIO */
	_PAD_CFG_STRUCT(VGPIO_PCIE_48, PAD_FUNC(GPIO) | PAD_RESET(DEEP) | PAD_BUF(TX_DISABLE) | PAD_CFG0_NAFVWE_ENABLE, 0),
	/* VGPIO_PCIE_49 - GPIO */
	_PAD_CFG_STRUCT(VGPIO_PCIE_49, PAD_FUNC(GPIO) | PAD_RESET(DEEP) | PAD_BUF(TX_DISABLE), 0),
	/* VGPIO_PCIE_5 - GPIO */
	_PAD_CFG_STRUCT(VGPIO_PCIE_5, PAD_FUNC(GPIO) | PAD_RESET(RSMRST) | PAD_BUF(TX_DISABLE) | PAD_CFG0_NAFVWE_ENABLE, 0),
	/* VGPIO_PCIE_50 - GPIO */
	_PAD_CFG_STRUCT(VGPIO_PCIE_50, PAD_FUNC(GPIO) | PAD_RESET(DEEP) | PAD_BUF(TX_DISABLE) | PAD_CFG0_NAFVWE_ENABLE, 0),
	/* VGPIO_PCIE_51 - NF5 */
	_PAD_CFG_STRUCT(VGPIO_PCIE_51, PAD_FUNC(NF5) | PAD_RESET(PWROK) | PAD_CFG0_NAFVWE_ENABLE, 0),
	/* VGPIO_PCIE_52 - NF3 */
	_PAD_CFG_STRUCT(VGPIO_PCIE_52, PAD_FUNC(NF3) | PAD_RESET(PWROK), 0),
	/* VGPIO_PCIE_53 - NF1 */
	_PAD_CFG_STRUCT(VGPIO_PCIE_53, PAD_FUNC(NF1) | PAD_RESET(RSMRST) | PAD_CFG0_NAFVWE_ENABLE, 0),
	/* VGPIO_PCIE_54 - NF7 */
	_PAD_CFG_STRUCT(VGPIO_PCIE_54, PAD_FUNC(NF7) | PAD_RESET(PWROK) | PAD_CFG0_NAFVWE_ENABLE, 0),
	/* VGPIO_PCIE_55 - NF3 */
	_PAD_CFG_STRUCT(VGPIO_PCIE_55, PAD_FUNC(NF3) | PAD_RESET(PWROK), 0),
	/* VGPIO_PCIE_56 - GPIO */
	...
	/* VGPIO_PCIE_59 - GPIO */
	_PAD_CFG_STRUCT(VGPIO_PCIE_59, PAD_FUNC(GPIO) | PAD_RESET(DEEP) | PAD_BUF(TX_DISABLE) | PAD_CFG0_NAFVWE_ENABLE, 0),
	/* VGPIO_PCIE_6 - GPIO */
	_PAD_CFG_STRUCT(VGPIO_PCIE_6, PAD_FUNC(GPIO) | PAD_RESET(PWROK) | PAD_BUF(TX_DISABLE) | PAD_CFG0_NAFVWE_ENABLE, 0),
	/* VGPIO_PCIE_60 - GPIO */
	_PAD_CFG_STRUCT(VGPIO_PCIE_60, PAD_FUNC(GPIO) | PAD_RESET(DEEP) | PAD_BUF(TX_DISABLE), 0),
	/* VGPIO_PCIE_61 - GPIO */
	_PAD_CFG_STRUCT(VGPIO_PCIE_61, PAD_FUNC(GPIO) | PAD_RESET(PLTRST) | PAD_BUF(TX_DISABLE), 0),
	/* VGPIO_PCIE_62 - GPIO */
	_PAD_CFG_STRUCT(VGPIO_PCIE_62, PAD_FUNC(GPIO) | PAD_RESET(PLTRST) | PAD_BUF(TX_DISABLE) | PAD_CFG0_NAFVWE_ENABLE, 0),
	/* VGPIO_PCIE_63 - NF2 */
	_PAD_CFG_STRUCT(VGPIO_PCIE_63, PAD_FUNC(NF2) | PAD_RESET(DEEP), 0),
	/* VGPIO_PCIE_64 - NF6 */
	_PAD_CFG_STRUCT(VGPIO_PCIE_64, PAD_FUNC(NF6) | PAD_RESET(PLTRST) | PAD_CFG0_NAFVWE_ENABLE, 0),
	/* VGPIO_PCIE_65 - GPIO */
	_PAD_CFG_STRUCT(VGPIO_PCIE_65, PAD_FUNC(GPIO) | PAD_RESET(PWROK) | PAD_BUF(RX_DISABLE) | PAD_CFG0_NAFVWE_ENABLE, 0),
	/* VGPIO_PCIE_66 - GPIO */
	_PAD_CFG_STRUCT(VGPIO_PCIE_66, PAD_FUNC(GPIO) | PAD_RESET(DEEP) | PAD_BUF(TX_DISABLE), 0),
	/* VGPIO_PCIE_67 - GPIO */
	_PAD_CFG_STRUCT(VGPIO_PCIE_67, PAD_FUNC(GPIO) | PAD_RESET(PWROK) | PAD_BUF(RX_DISABLE) | 1 | PAD_CFG0_NAFVWE_ENABLE, 0),
	/* VGPIO_PCIE_68 - NF3 */
	_PAD_CFG_STRUCT(VGPIO_PCIE_68, PAD_FUNC(NF3) | PAD_RESET(RSMRST), 0),
	/* VGPIO_PCIE_69 - GPIO */
	_PAD_CFG_STRUCT(VGPIO_PCIE_69, PAD_FUNC(GPIO) | PAD_RESET(PWROK) | PAD_BUF(TX_DISABLE) | PAD_CFG0_NAFVWE_ENABLE, 0),
	/* VGPIO_PCIE_7 - GPIO */
	_PAD_CFG_STRUCT(VGPIO_PCIE_7, PAD_FUNC(GPIO) | PAD_RESET(PLTRST) | PAD_BUF(TX_DISABLE) | PAD_CFG0_NAFVWE_ENABLE, 0),
	/* VGPIO_PCIE_70 - GPIO */
	_PAD_CFG_STRUCT(VGPIO_PCIE_70, PAD_FUNC(GPIO) | PAD_RESET(RSMRST) | PAD_BUF(RX_DISABLE) | 1, 0),
	/* VGPIO_PCIE_71 - GPIO */
	_PAD_CFG_STRUCT(VGPIO_PCIE_71, PAD_FUNC(GPIO) | PAD_RESET(PWROK) | PAD_BUF(TX_DISABLE) | PAD_CFG0_NAFVWE_ENABLE, 0),
	/* VGPIO_PCIE_72 - GPIO */
	_PAD_CFG_STRUCT(VGPIO_PCIE_72, PAD_FUNC(GPIO) | PAD_RESET(PWROK) | PAD_BUF(RX_DISABLE) | 1, 0),
	/* VGPIO_PCIE_73 - NF4 */
	_PAD_CFG_STRUCT(VGPIO_PCIE_73, PAD_FUNC(NF4) | PAD_RESET(PLTRST), 0),
	/* VGPIO_PCIE_74 - GPIO */
	_PAD_CFG_STRUCT(VGPIO_PCIE_74, PAD_FUNC(GPIO) | PAD_RESET(PWROK) | PAD_BUF(TX_DISABLE), 0),
	/* VGPIO_PCIE_75 - GPIO */
	_PAD_CFG_STRUCT(VGPIO_PCIE_75, PAD_FUNC(GPIO) | PAD_RESET(DEEP) | PAD_BUF(RX_DISABLE), 0),
	/* VGPIO_PCIE_76 - NF5 */
	_PAD_CFG_STRUCT(VGPIO_PCIE_76, PAD_FUNC(NF5) | PAD_RESET(RSMRST) | PAD_CFG0_NAFVWE_ENABLE, 0),
	/* VGPIO_PCIE_77 - GPIO */
	...
	/* VGPIO_PCIE_79 - GPIO */
	_PAD_CFG_STRUCT(VGPIO_PCIE_79, PAD_FUNC(GPIO) | PAD_RESET(PWROK) | PAD_BUF(TX_DISABLE), 0),
	/* VGPIO_PCIE_8 - GPIO */
	...
	/* VGPIO_PCIE_9 - GPIO */
	_PAD_CFG_STRUCT(VGPIO_PCIE_9, PAD_FUNC(GPIO) | PAD_RESET(PWROK) | PAD_BUF(TX_DISABLE), 0),
};
